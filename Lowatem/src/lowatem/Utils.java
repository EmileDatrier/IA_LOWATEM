...
public class Utils {
    ...
    static float coutDeplacement(char typeUnite) {
        float coutDeplacement = 0;
        switch (typeUnite) {
            
            case Utils.CAR_SOLDATS:
                coutDeplacement = (float) 0.3;
                break;
                
            case Utils.CAR_CHAR:
                coutDeplacement = (float) 0.7;
                break;
                
            case Utils.CAR_LM:
                coutDeplacement = (float) 0.4;
                break;
                
            case Utils.CAR_AVION:
                coutDeplacement = (float) 0.7;
                break;
                
            case Utils.CAR_NAVIRE:
                coutDeplacement = (float) 0.6;
                break;
        }
    ...
    static int degatsAttaque(char typeUnite) {
        int degatsAttaque = 0;
        switch (typeUnite) {
    ...
    static int degatsAttaquant(char typeUnite) {
        int degatsAttaquant = 0;
        switch (typeUnite) {
        ...
        return degatsAttaquant;        
    }

    static int portee(char typeUnite) {
        int portee = 0;
        switch (typeUnite) {
